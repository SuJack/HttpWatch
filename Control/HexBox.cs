namespace HttpWatch.Control
{
    ...
    public class HexBox : Control
    {
        ...
        private void CreateCaret()
        {
            ...
            {
                HttpWatch.Control.NativeMethods.CreateCaret(base.Handle, IntPtr.Zero, 1, (int) this._charSize.Height);
                this.UpdateCaret();
                HttpWatch.Control.NativeMethods.ShowCaret(base.Handle);
        ...
        private void DestroyCaret()
        {
            ...
            {
                HttpWatch.Control.NativeMethods.DestroyCaret();
        ...
        private void UpdateCaret()
        {
            if ((this._byteProvider != null) && (this._keyInterpreter != null))
            {
                ...
                HttpWatch.Control.NativeMethods.SetCaretPos((int) caretPointF.X, (int) caretPointF.Y);
            }
        }
        ...
        [DefaultValue(typeof(HttpWatch.Control.HexCasing), "Upper"), Description("Gets or sets whether the HexBox control displays the hex characters in upper or lower case."), Category("Hex")]
        public HttpWatch.Control.HexCasing HexCasing
        {
            get
            {
                if (this._hexStringFormat == "X")
                {
                    return HttpWatch.Control.HexCasing.Upper;
                }
                return HttpWatch.Control.HexCasing.Lower;
            }
            set
            {
                string str;
                if (value == HttpWatch.Control.HexCasing.Upper)
                {
                    str = "X";
                }
                else
